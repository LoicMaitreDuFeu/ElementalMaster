...
public class DarkRuinedPortalStructureStructure extends ElementalmasterModElements.ModElement {
	public DarkRuinedPortalStructureStructure(ElementalmasterModElements instance) {
		super(instance, 719);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 8000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("elementalmaster", "darkruinedportal"));
						if (template == null)
							return false;
