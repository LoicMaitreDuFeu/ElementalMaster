...
package net.bukkit.elementalmaster.world.dimension;
...
import net.bukkit.elementalmaster.item.DarkDimensionItem;
import net.bukkit.elementalmaster.block.DarkStoneBlock;
import net.bukkit.elementalmaster.block.DarkMatterBlock;
...
public class DarkDimensionDimension extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_dimension")
	public static final ModDimension dimension = null;
	@ObjectHolder("elementalmaster:dark_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public DarkDimensionDimension(ElementalmasterModElements instance) {
		super(instance, 259);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("dark_dimension"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("elementalmaster:dark_dimension")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("elementalmaster:dark_dimension"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("elementalmaster:dark_dimension"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new DarkDimensionItem().setRegistryName("dark_dimension"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			super(Block.Properties.create(Material.PORTAL).doesNotBlockMovement().tickRandomly().hardnessAndResistance(-1.0F).sound(SoundType.GLASS)
					.lightValue(8).noDrops());
			setRegistryName("dark_dimension_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = DarkDimensionDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("dark_dimension_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "dark_dimension_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = DarkDimensionDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				...
				public BlockState getDefaultFluid() {
					return DarkMatterBlock.block.getDefaultState();
				}
			});
