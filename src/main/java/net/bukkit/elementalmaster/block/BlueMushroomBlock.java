...
public class BlueMushroomBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:blue_mushroom")
	public static final Block block = null;
	public BlueMushroomBlock(ElementalmasterModElements instance) {
		super(instance, 696);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(ElementalPlantsItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).lightValue(12));
			setRegistryName("blue_mushroom");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("These little mushs helps to make light in obscurity"));
		}
