...
public class PurpleMushroomBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:purplemushroom")
	public static final Block block = null;
	public PurpleMushroomBlock(ElementalmasterModElements instance) {
		super(instance, 262);
	}
