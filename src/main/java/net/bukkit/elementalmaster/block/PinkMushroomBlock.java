...
public class PinkMushroomBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:pink_mushroom")
	public static final Block block = null;
	public PinkMushroomBlock(ElementalmasterModElements instance) {
		super(instance, 714);
	}
