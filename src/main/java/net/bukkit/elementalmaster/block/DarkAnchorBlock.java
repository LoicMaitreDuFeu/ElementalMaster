...
import net.bukkit.elementalmaster.procedures.DarkAnchorUpdateTickProcedure;
...
public class DarkAnchorBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_anchor")
	public static final Block block = null;
	public DarkAnchorBlock(ElementalmasterModElements instance) {
		super(instance, 716);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				DarkAnchorUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
