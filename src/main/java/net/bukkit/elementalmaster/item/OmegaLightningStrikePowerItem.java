...
public class OmegaLightningStrikePowerItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:omega_lightning_strike_power")
	public static final Item block = null;
	public OmegaLightningStrikePowerItem(ElementalmasterModElements instance) {
		super(instance, 223);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("omega_lightning_strike_power");
		}
