...
public class LightningStrikePower2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightning_strike_power_2")
	public static final Item block = null;
	public LightningStrikePower2Item(ElementalmasterModElements instance) {
		super(instance, 222);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lightning_strike_power_2");
		}
